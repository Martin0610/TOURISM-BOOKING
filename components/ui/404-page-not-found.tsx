  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-white">
      ...
      >
        ...
        <circle cx="649.24878" cy="51" r="51" fill="currentColor"/>
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="md:text-lg lg:text-xl text-gray-600 mt-4 text-center px-4">
          Sorry, the page you are looking for could not be found.
        </p>
        <Link
          href="/"
          className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 mt-10 rounded-xl transition duration-150 font-medium"
        >
