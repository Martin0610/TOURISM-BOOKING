...
export default function PolicyModal({ type, onClose, onAccept }: PolicyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      {/* Clean, professional modal card */}
      <div 
        className={`relative w-full max-w-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] z-10 text-slate-900 dark:text-white transition-all duration-300 ease-out transform ${
          isVisible 
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-base text-slate-900 dark:text-white">
                ...
                {activeType === 'cancellation' && 'Cancellation & Refund Policy'}
              </h3>
        ...
        <div 
          ...
          className="p-6 overflow-y-auto space-y-4 text-sm text-slate-600 dark:text-slate-300 leading-relaxed max-h-[55vh]"
        >
          {activeType === 'terms' && (
            <>
              <div className="p-3.5 bg-blue-50 dark:bg-slate-800/80 rounded-xl border border-blue-100 dark:border-slate-700 text-xs text-blue-900 dark:text-blue-200 font-medium leading-relaxed">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 1. Booking & Account Agreement
                </h4>
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 2. Special Offers & Discounts
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 3. Departure & Transit Arrangements
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 4. Traveler Conduct & Responsibilities
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 5. Modifications & Amendments
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
          ...
          {activeType === 'privacy' && (
            <>
              <div className="p-3.5 bg-blue-50 dark:bg-slate-800/80 rounded-xl border border-blue-100 dark:border-slate-700 text-xs text-blue-900 dark:text-blue-200 font-medium flex items-center gap-2.5">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 1. Data Collection & Purpose
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 2. Bank-Grade Payment Security
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 3. Account Protection & Encryption
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 4. Data Retention & User Rights
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
          ...
          {activeType === 'cancellation' && (
            <>
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 1. 100% Free Cancellation Window
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 2. Partial Refund (3 to 7 Days)
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 flex-shrink-0" /> 3. Fast Automated Refund Processing
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pl-6">
          ...
          {(() => {
            ...
            return (
              <div className="p-4 bg-slate-900 rounded-xl border border-slate-800 flex items-center justify-between text-white shadow-sm">
                <div>
                  <p className="text-xs font-bold text-white">Have questions about this policy?</p>
                  <p className="text-[11px] text-slate-400">Our support desk is available to clarify any doubts.</p>
                </div>
                <a 
                  href={gmailComposeUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold transition cursor-pointer"
                >
        ...
        <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/80 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2 text-xs">
            {!hasScrolledToBottom ? (
              <button
                ...
                className="inline-flex items-center gap-1.5 text-blue-600 dark:text-blue-400 font-semibold hover:underline cursor-pointer transition-colors"
              >
          ...
          <button
            ...
            className={`px-5 py-2 rounded-lg font-semibold text-xs transition-colors shadow-sm flex items-center gap-2 cursor-pointer ${
              hasScrolledToBottom
