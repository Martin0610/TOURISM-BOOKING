...
export async function GET() {
  try {
    const updates = [
      ...
      { pattern: 'Manali', url: 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=800' },
      { pattern: 'Ladakh', url: 'https://images.unsplash.com/photo-1581793745862-99fde7fa73d2?w=800' },
